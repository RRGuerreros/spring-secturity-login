...
public class UserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		Usuario appUser = usuarioRepository.findByUsuario( username );
        ...
        return new User(appUser.getUsuario(), appUser.getPassword(), appUser.getEstado(), true, true, true, authorities);
	}
