...
public class PrincipalController {
	...
	public String menu() {
	    ...
	    Usuario usuario = usuarioRepository.findByUsuario( userDetail.getUsername() );
	    
	    log.info("el usuario "+usuario.getUsuario()+" ah solicitado iniciar sesion");
	    log.info("estado del usuario -> " + (usuario.getEstado()? "Activo" :"Inactivo"));
